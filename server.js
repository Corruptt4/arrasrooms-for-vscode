    ...
    return {
        ...
        connect: (() => {
            ...
            function incoming(message, socket) {
                ...
                case "A": { // Multibox
                   if (m.length !== 0) { socket.kick('Ill-sized multibox request.'); return 1; }
    ...
    let collide = (() => {
        ...
        return collision => {
            ...
            if (instance.settings.hitsOwnType === other.settings.hitsOwnType) {
                ...
                case 'tanksOnly': if(instance.type == "tank" && other.type == "tank" || other.type == "tank" && instance.type == "tank") firmcollide(instance, other, 0)
...
var maintainloop = (() => {
    ...
    let makefood = (() => {
        ...
        function getFoodClass2(level) {
            let a = { };
            switch (ran.chooseChance(100, 50, 25, 12.5)) {
                case 0: a = Class.egg; break;
        ...
        let placeNewFood = (position, scatter, level, allowInNest = false) => {
            ...
            if (scatter != -1 || mitosis || seed) {
                // Splitting
                if (o != null && (mitosis || seed) && room.isIn('roid', o) === allowInNest) {
                ...
                // Brand new
                else if (room.isIn('roid', position) === allowInNest) {
                    if (!dirtyCheck(position, 20)) {
                        o = new Entity(room.randomType("roid")); // position is default used once you remix, use room.randomType("your room name here")
